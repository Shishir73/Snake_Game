...
int main()
{
	...
	setfillstyle(1,1);
	bar(s-s/2,s-s/2,(s/2)+s*(1350/s),s+s/2); //top bar
	bar(s-s/2,(-s/2)+s*(700/s),(s/2)+s*(1350/s),(s/2)+s*(700/s)); //bottom bar
	bar(s-s/2,s-s/2,s+s/2,(s/2)+s*(700/s));  //left bar
	bar((-s/2)+s*(1350/s),s-s/2,(s/2)+s*(1350/s),(s/2)+s*(700/s)); //right bar
    ...
    //Placing food at random location
    rx=s; ry=s;
    setfillstyle(1,2);
